...
On DTLZ2 with $m{=}10$ objectives and $K{=}m{=}10$ evaluations per iteration, qSTCH-Set achieves hypervolume $46.95 \pm 1.31$, outperforming qNParEGO ($q{=}1$; $44.10 \pm 0.99$) by 6.5\%; budget-matched comparisons (qNParEGO with $q{=}m$) are provided in Appendix~\ref{app:budget-matched}.
At $m{=}8$ with $K{=}m{=}8$, qSTCH-Set approaches qNParEGO ($20.22$ vs $20.89$), closing a gap that exists with smaller $K$ (from $19.26$ to $20.22$, a 5\% improvement).
...
\begin{enumerate}
    ...
    \item On DTLZ2, qSTCH-Set with $K{=}m$ outperforms qNParEGO ($q{=}1$) by 6.5\% at $m{=}10$ objectives and approaches it at $m{=}8$, with the advantage growing as objective dimensionality increases; budget-matched comparisons are in Appendix~\ref{app:budget-matched} (\S\ref{sec:experiments}).
...
\caption{Convergence on DTLZ2 with $m{=}5$ objectives, $K{=}5$ (5 seeds). At this modest objective count, qNParEGO ($6.44 \pm 0.16$) slightly outperforms qSTCH-Set ($6.22 \pm 0.50$), reflecting that random scalarization weights still cover the Pareto front adequately when $m$ is small. qSTCH-Set's advantage emerges at higher~$m$. Error bands show $\pm 1$ standard deviation.}
...
\caption{Convergence on DTLZ2 with $m{=}8$ objectives, $K{=}8$ (5 seeds). qSTCH-Set ($20.22 \pm 1.90$) is competitive with qNParEGO ($20.89 \pm 0.83$), closing the gap that exists with $K{=}5$ (from $19.26$ to $20.22$, a 5\% improvement). Error bands show $\pm 1$ standard deviation.}
...
\end{tabular}
\vspace{2pt}
{\footnotesize $*$ Not run in the $K{=}m$ campaign at $m{=}5$.\\
$\ddagger$ Random at $m{=}10$: 4 of 5 seeds completed.\\
STCH-NParEGO and Random results at $m{=}8$ and $m{=}10$ are from the $K{=}5$ campaign (5 seeds); dedicated $K{=}m$ baseline re-runs are in progress.}
\end{table}
