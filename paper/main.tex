...
\begin{table}[h]
\centering
\caption{Real-world benchmark results (HV $\uparrow$, 5 seeds, 20 iters). At $m \le 4$, hypervolume-based methods (qEHVI, qNEHVI) are tractable and remain the gold standard. qSTCH-Set is competitive with qNParEGO, demonstrating reliable performance across problem types.}
...
\midrule
\textbf{qSTCH-Set} (ours) & $17.16 \pm 0.62$ & $26.85 \pm 1.10$ & $42.16 \pm 1.65$ \\
qNParEGO & $17.42 \pm 0.37$ & $27.02 \pm 0.89$ & $41.20 \pm 1.43$ \\
qEHVI & $18.23 \pm 0.32$ & $28.43 \pm 0.65$ & $44.87 \pm 0.99$ \\
qNEHVI & $\mathbf{18.44 \pm 0.29}$ & $\mathbf{29.11 \pm 0.52}$ & $\mathbf{45.20 \pm 0.81}$ \\
Random & $16.88 \pm 0.55$ & $23.89 \pm 1.24$ & $35.61 \pm 2.19$ \\
\bottomrule
\end{tabular}
\end{table}
