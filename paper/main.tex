...
On DTLZ2, qSTCH-Set outperforms qNParEGO ($q{=}1$) at all tested dimensionalities, with the advantage growing with~$m$: $+4\%$ at $m{=}5$ ($6.69 \pm 0.16$ vs $6.43 \pm 0.25$), $+6.4\%$ at $m{=}8$ ($23.00 \pm 0.72$ vs $21.61 \pm 0.83$), and $+9.7\%$ at $m{=}10$ ($51.94 \pm 0.74$ vs $47.35 \pm 0.86$); budget-matched comparisons (qNParEGO with $q{=}m$) are provided in Appendix~\ref{app:budget-matched}.
...
\midrule
\textbf{qSTCH-Set (ours)} & $\mathbf{6.69 \pm 0.16}$ & $\mathbf{23.00 \pm 0.72}$ & $\mathbf{51.94 \pm 0.74}$ \\
qNParEGO & $6.43 \pm 0.25$ & $21.61 \pm 0.83$ & $47.35 \pm 0.86$ \\
STCH-NParEGO & $6.12 \pm 0.16$ & $20.62 \pm 1.46$ & $44.19 \pm 1.33$ \\
Random & $5.37 \pm 0.13$ & $18.03 \pm 0.20$ & $42.06 \pm 0.30$ \\
\bottomrule
\end{tabular}
\vspace{2pt}
{\footnotesize All results: 5 seeds at $m{=}5$, 3 seeds at $m{=}8$ and $m{=}10$; 30/25/20 BO iterations respectively. Additional seeds running on Nibi cluster.}
\end{table}
