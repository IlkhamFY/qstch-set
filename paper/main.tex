...
\begin{table}[h]
\centering
\caption{Real-world benchmark results (HV $\uparrow$, 5 seeds, 20 iters, $K{=}m$). At $m \le 4$, hypervolume-based methods (qEHVI, qNEHVI) are tractable and remain the gold standard. qSTCH-Set is competitive with qNParEGO across all three problems.}
...
\midrule
\textbf{qSTCH-Set} (ours) & \placeholder{} & \placeholder{} & \placeholder{} \\
qNParEGO & \placeholder{} & \placeholder{} & \placeholder{} \\
qEHVI & \placeholder{} & \placeholder{} & \placeholder{} \\
qNEHVI & \placeholder{} & \placeholder{} & \placeholder{} \\
Random & \placeholder{} & \placeholder{} & \placeholder{} \\
\bottomrule
\end{tabular}
\end{table}

As expected, qNEHVI and qEHVI dominate at $m \le 4$ where exact hypervolume partitioning is tractable.
