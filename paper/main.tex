...
ParEGO~\citep{knowles2006parego} and qNParEGO~\citep{daulton2020qnehvi} use random Chebyshev weight vectors, treating each batch element as an independent scalarized problem with no coordination; for $m \gg 5$, the random weights concentrate in the simplex interior and fail to cover extremal Pareto directions.
