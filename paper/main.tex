...
\textbf{Scaling to $m=8$.} With $K{=}m{=}8$, qSTCH-Set achieves HV $20.22 \pm 1.90$, comparable to qNParEGO $\mathbf{20.45 \pm 0.53}$ (3/5 seeds). The gap has closed substantially from the $K{=}5$ default ($19.26$ vs $20.89$), demonstrating that matching $K$ to $m$ is critical. STCH-NParEGO ($16.63 \pm 0.23$) and Random ($17.63 \pm 0.29$) fall well behind both methods.
