...
\begin{enumerate}
    ...
    \item For $K{=}1$, consistency follows from the composite BO result of \cite{astudillo2019composite} and the sublinear regret bound for random scalarization BO~\cite{paria2019mobo}. For $K{>}1$, the set-valued optimization introduces permutation symmetries requiring set-valued epi-convergence arguments (Rockafellar \& Wets, Ch.~7) that remain open.
\end{enumerate}
